...
from ..living_system import save_thought, retrieve_memories
...
def tree_of_thought_chain(problem_description, llm):
...
# Note: llm needs to be defined or imported before this line
result = tree_of_thought_chain(problem_description, llm)
