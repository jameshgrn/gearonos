...
class Orchestrator:
    def __init__(self, llm: LLM):
        ...
        self.initial_message = (
            ...
            "achieve pure contentedness, and assist in complex problem-solving, introspective reflection, "
            "and the generation of innovative hypotheses. Let's embark on this journey together."
        )
...
if __name__ == '__main__':
    ...
    hypothesis_input = "hypothesize: What if humans could photosyn this input."
