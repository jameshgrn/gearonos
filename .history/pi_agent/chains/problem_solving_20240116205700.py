...
''', input_variables=["memory_context", "problem_statement"])
    ...
    response = llm_chain.invoke(input = memory_context=memory_context, problem_statement=problem_statement)
...
# Test the problem_solving_chain function
if __name__ == '__main__':
    ...
    print("Test Problem-Solving Chain:")
