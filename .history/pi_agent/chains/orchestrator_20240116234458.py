...
from pi_agent.chains.keyword_extractor import KeywordExtractor
from pi_agent.chains.tree_of_thought import tree_of_thought_chain
from pi_agent.chains.hypothesis_generation import hypothesis_generation_chain
from pi_agent.chains.problem_solving import problem_solving_chain
from pi_agent.chains.reflection_introspection import reflection_introspection_chain
from pi_agent.living_system import llm  # Assuming llm is initialized in the living_system.py
...
class Orchestrator:
    ...
    def orchestrate(self, input_text):
        ...
        if "solve" in decision:
            ...
            return tree_of_thought_chain(input_text, self.llm)
        else:
